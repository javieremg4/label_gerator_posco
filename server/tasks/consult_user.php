    ...
    if(isset($_POST['user']) || isset($_POST['mail'])){
        ...
        if($result[0]){
            ...
            "<p>Hola ".$result['user_name'].".</p>
             ...
             "<a href='http://192.168.70.5/qrCreator_Posco/pages/reset_pwd.php?user=".base64_encode($result['user_id'])."'>http://192.168.70.5/qrCreator_Posco/pages/reset_pwd.php?user=".base64_encode($result['user_id'])."</a>"."<br>
